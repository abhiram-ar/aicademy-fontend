...
const DropdownMenuContent = React.forwardRef<
    ...
    // @ts-expect-error
>(({ className, port = true, sideOffset = 4, ...props }, ref) => {
    const Context = (
    ...
    return port ? (
        <DropdownMenuPrimitive.Portal>{Context}</DropdownMenuPrimitive.Portal>
    ) : (
        Context
    );
});
